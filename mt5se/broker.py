...
# --- NOVA ALTERAÇÃO: Início ---
# Variável global para o override de capital durante o backtest de portfólio.
_capital_override = None
# --- NOVA ALTERAÇÃO: Fim ---
...
# --- NOVA ALTERAÇÃO: Início ---
def set_capital_override(capital: float = None):
    """
    Define ou remove um valor de override para o capital disponível.
    Usado pelo backtester de portfólio para injetar o capital alocado.
    """
    global _capital_override
    _capital_override = capital
# --- NOVA ALTERAÇÃO: Fim ---
